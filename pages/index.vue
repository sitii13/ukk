<template>
  <div>
    ...
    <section class="header-image-section">
      <img src="~/assets/img/17 agustus.jpg" alt="Selamat Datang Di Website SMKN 4" class="img-fluid w-100" />
    </section>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-8">
            <p class="lead">Assalamualaikum warahmatullahi wabarakatuh,
              ...
              Alhamdulillah, puji syukur kita panjatkan kepada Tuhan Yang Maha Esa, karena berkat rahmat dan
              karunia-Nya, kita diberikan kesempatan untuk terus berkembang dalam dunia pendidikan. Website ini kami
              hadirkan sebagai sarana komunikasi dan informasi yang dapat mempermudah hubungan antara sekolah, siswa,
              orang tua, dan masyarakat luas.Di SMKN 4 Tasikmalaya, kami percaya bahwa pendidikan adalah investasi
              terbaik bagi masa depan bangsa. Oleh karena itu, kami selalu berkomitmen untuk memberikan layanan
              pendidikan yang berkualitas, mencetak generasi yang cerdas, berkarakter, serta siap menghadapi tantangan
              global.Kami juga sangat menghargai peran serta orang tua dan masyarakat dalam mendukung kemajuan sekolah
              ini. Semoga melalui informasi yang ada di website ini, kita dapat mempererat kerja sama yang telah
              terjalin dan membangun lingkungan belajar yang lebih baik.Terima kasih atas perhatian dan kepercayaan yang
              diberikan kepada kami. Semoga SMKN 4 Tasikmalaya dapat terus memberikan kontribusi terbaik untuk
              pendidikan dan kemajuan anak bangsa.Wassalamualaikum warahmatullahi wabarakatuh.</p>
